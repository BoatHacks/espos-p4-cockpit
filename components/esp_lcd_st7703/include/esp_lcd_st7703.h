...
// Vendored copy: upstream sources these from cmake_utilities'
// cu_pkg_define_version() (a generated header). We strip that build
// dependency, so define the version the .c logs itself (1.0.1).
#ifndef ESP_LCD_ST7703_VER_MAJOR
#define ESP_LCD_ST7703_VER_MAJOR 1
#define ESP_LCD_ST7703_VER_MINOR 0
#define ESP_LCD_ST7703_VER_PATCH 1
#endif
