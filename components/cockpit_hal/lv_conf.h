/**
 * LVGL 9.x configuration for the espOS cockpit (components/cockpit_hal).
 *
...
/* --- OS --- */
#define LV_USE_OS LV_OS_NONE  /* lv_timer_handler() runs on the cockpit_hal ui task; callers use ui::post() */
