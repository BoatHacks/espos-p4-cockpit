...
#include "cockpit_voice/protocol/events.h"
#include "cockpit_voice/wake_engine.h"
...
class WyomingSatellite {
 public:
  WyomingSatellite(cockpit_hal::AudioDriver* audio,
  ...
  bool probe_mic_levels(cockpit_hal::AudioDriver::MicLevels& out);
